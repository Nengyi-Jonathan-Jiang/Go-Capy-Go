...
new Level("Rube Goldberg Machine", document.getElementById("level-4-background"), function(level, player, berry){
    ...
    doorManager2.linkDoor(level.addDoorAt(10.5, 2.5, 1, 1))
    doorManager2.linkButton(level.addButtonAt(8.5, 4))
    let doorManager3 = level.addDoorManager("#caf");
    doorManager3.linkDoor(level.addDoorAt(11.5, 7, 1, 2))
    doorManager3.linkButton(level.addButtonAt(10.5, 4))
}),
/*
@name "A Scarlet Fish"
