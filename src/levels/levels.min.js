...
platform 10 2 1 6
*/
new Level("Doors and Buttons", document.getElementById("level-2-background"), function(level, player, berry){
...
new Level("A Ghostly Helper", document.getElementById("level-3-background"), function(level, player, berry){
    level.addPlatformAt(4.5, 4.25, 9, 0.5);
...
box 9 0
*/
new Level("Rube Goldberg I", document.getElementById("level-4-background"), function(level, player, berry){
    level.addPlatformAt(4.5, 6.25, 3, 0.5);
    level.addPlatformAt(8.5, 6.5, 1, 1);
    level.addPlatformAt(10, 4.25, 4, 0.5);
    level.addPlatformAt(11.5, 3, 1, 6);
    level.addBoxAt(4.5, 5.5);
    level.addBoxAt(8.5, 1.5);
    level.addBoxAt(10.5, 1.5);
    let doorManager0 = level.addDoorManager("#fac");
    doorManager0.linkDoor(level.addDoorAt(8.5, 7.5, 1, 1))
    doorManager0.linkButton(level.addButtonAt(1.5, 8))
    let doorManager1 = level.addDoorManager("#4fc");
    doorManager1.linkDoor(level.addDoorAt(8.5, 5.25, 1, 1.5))
    doorManager1.linkDoor(level.addDoorAt(8.5, 2.5, 1, -1))
    doorManager1.linkButton(level.addButtonAt(10.5, 8))
    let doorManager2 = level.addDoorManager("#fd4");
    doorManager2.linkDoor(level.addDoorAt(11.5, 7, 1, 2))
    doorManager2.linkButton(level.addButtonAt(10.5, 4))
    let doorManager3 = level.addDoorManager("#caf");
    doorManager3.linkDoor(level.addDoorAt(10.5, 2.5, 1, -1))
    doorManager3.linkButton(level.addButtonAt(8.5, 4))
}),
/*
@name "Scarlet Fish"
...
box 7 0
*/
new Level("Scarlet Fish", document.getElementById("level-5-background"), function(level, player, berry){
    level.addPlatformAt(4.5, 6.25, 3, 0.5);
    level.addPlatformAt(8.5, 6.5, 1, 1);
    level.addPlatformAt(10, 4.25, 4, 0.5);
...
pumpkin 9 2
*/
new Level("Semipermeable", document.getElementById("level-9-background"), function(level, player, berry){
    level.addPlatformAt(3.5, 7, 1, 2);
    level.addPlatformAt(5, 5.75, 2, 0.5);
    level.addPlatformAt(8, 4.25, 6, 0.5);
    level.addPlatformAt(9.5, 6.75, 1, 2.5);
...
pumpkin 0 .5
*/
new Level("Mind Games", document.getElementById("level-8-background"), function(level, player, berry){
    level.addPlatformAt(4, 4.5, 2, 1);
    level.addPlatformAt(8, 4.5, 2, 1);
    level.addPlatformAt(8.5, 5.5, 1, 3);
    level.addPlatformAt(11.5, 6.5, 1, 3);
    level.addBoxAt(3.5, 7.5);
    level.addBoxAt(3.5, 3.5);
    let doorManager0 = level.addDoorManager("#fac");
    doorManager0.linkDoor(level.addDoorAt(8.5, 2, 1, 2))
    doorManager0.linkButton(level.addButtonAt(9.5, 8))
    let doorManager1 = level.addDoorManager("#4fc");
    doorManager1.linkDoor(level.addDoorAt(6, 6, 2, -4))
    doorManager1.linkButton(level.addButtonAt(10.5, 8))
    let doorManager2 = level.addDoorManager("#caf");
    ...
    doorManager3.linkDoor(level.addDoorAt(11.5, 3, 1, 4))
    doorManager3.linkButton(level.addButtonAt(3.5, 4))
    let doorManager4 = level.addDoorManager("#bbb");
    doorManager4.linkDoor(level.addDoorAt(12.5, 4.5, 1, -7))
    doorManager4.linkButton(level.addButtonAt(1.5, 8))
    level.addBlockAt(8.5, 3.5);
    level.addBlockAt(8.5, 7.5);
}, function(level){
    level.addPumpkinAt(1.5, 1.9);
}),
/*
@name "Two Pillars"
@background "level-10-background"
...
pumpkin 3 0.5
*/
new Level("Two Pillars", document.getElementById("level-10-background"), function(level, player, berry){
...
box 12 3
*/
new Level("Remote Control", document.getElementById("level-7-background"), function(level, player, berry){
