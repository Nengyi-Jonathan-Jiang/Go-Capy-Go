...
new Level("Rube Goldberg Machine", document.getElementById("level-4-background"), function(level, player, berry){
    ...
    doorManager1.linkDoor(level.addDoorAt(10.5, 2.5, 1, -1))
...
box 12 3
*/
new Level("Package", document.getElementById("level-6-background"), function(level, player, berry){
...
box 12 3
*/
new Level("Caged Lion", document.getElementById("level-7-background"), function(level, player, berry){
    level.addPlatformAt(3, 6.25, 4, 0.5);
